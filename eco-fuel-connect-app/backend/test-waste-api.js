...
async function testWasteLogging() {
  ...
  try {
    ...
    console.log('2️⃣ Fetching available waste types...');
    ...
    console.log('3️⃣ Creating test waste entry...');
    const wasteData = {
      producerId: user.id, // Use current user as producer
    ...
    console.log('4️⃣ Fetching all waste entries...');
